...
def run_training():
	...
	with tf.Graph().as_default():
		...
		#with slim.arg_scope(resnet_v2.resnet_arg_scope()):
			...
			logits,description=alexnet.alexnet_v2(images,num_classes=gd.NUM_CLASSES,is_training=True)
			print('logits:')
			print(logits)
			print('description:')
			print(description)
			...
			#loss=slim.losses.softmax_cross_entropy(logits, labels)		
                	logits_val,_=alexnet.alexnet_v2(images_val,num_classes=gd.NUM_CLASSES,is_training=True)
